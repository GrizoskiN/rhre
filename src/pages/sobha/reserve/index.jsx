...
export default function Index() {
  const photos = [
    {
      src: "/img/sobha/reserve/gallery/5.jpg",
      alt: "Image 1",
      width: 600,
      height: 800,
    },
    {
      src: "/img/sobha/reserve/gallery/2.jpg",
      alt: "Image 2",
      width: 800,
      height: 520,
    },
    {
      src: "/img/sobha/reserve/gallery/3.jpg",
      alt: "Image 1",
      width: 800,
      height: 520,
    },
    {
      src: "/img/sobha/reserve/gallery/1.jpg",
      alt: "Image 2",
      width: 800,
      height: 520,
    },
    {
      src: "/img/sobha/reserve/gallery/4.jpg",
      alt: "Image 2",
      width: 800,
      height: 517,
    },
  ...
  return (
    <>
    <Head>
    <title>Sobha Realty - Reserve | RHRE | Dubai, UAE</title>

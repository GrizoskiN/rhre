    ...
    <>
      ...
      <div className="relative ">
        <div className="absolute top-32 2xl:top-[35%] right-0 z-10 text-white text-right font-light mr-[5%] 2xl:mr-48">
          ...
          Step out of your front door and into Golden Gardens,
tennis courts, sports fields, jogging paths, a state-of-the-art
gym, a children’s playland and an exciting list of exquisite
dining venues.
          </p>

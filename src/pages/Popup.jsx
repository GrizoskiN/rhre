...
const Popup = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      ...
      <div className="bg-white w-full p-4 rounded shadow-md lg:w-1/4 lg:h-1/4 flex items-center text-center justify-center flex-col z-40">
        <h2 className="text-3xl font-light mb-2">Thank you for contacting us <br/><span className="font-bold">{name}</span></h2>

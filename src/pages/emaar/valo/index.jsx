...
import header from "@/../public/img/emaar/valo/header.jpg";
import second from "@/../public/img/emaar/valo/second.jpg";
import third from "@/../public/img/emaar/valo/third.jpg";
import fourth from "@/../public/img/emaar/valo/fourth.jpg";
import oneqr from "@/../public/img/emaar/qr/valoqr.jpg";
...
export default function Index() {
  const photos = [
    {
      src: "/img/emaar/valo/gallery/5.jpg",
      alt: "Image 1",
      width: 600,
      height: 800,
    },
    {
      src: "/img/emaar/valo/gallery/2.jpg",
      alt: "Image 2",
      width: 800,
      height: 520,
    },
    {
      src: "/img/emaar/valo/gallery/3.jpg",
      alt: "Image 1",
      width: 800,
      height: 520,
    },
    {
      src: "/img/emaar/valo/gallery/1.jpg",
      alt: "Image 2",
      width: 800,
      height: 520,
    },
    {
      src: "/img/emaar/valo/gallery/4.jpg",
      alt: "Image 2",
      width: 800,
      height: 517,
    },
  ...
  return (
    <>
    <Head>
    <title>Emaar Properties - Valo | RHRE | Dubai, UAE</title>
    <meta name="description" content="Rise High Real Estate - Your trusted partner for buying, selling, and leasing properties in Dubai, UAE. Explore luxury apartments, townhouses, and villas with us." />
      ...
      <HeaderImage
        ...
        project={"Valo"}
        text={
          "Valo embodies contemporary sophistication, providing an exclusive blend of luxury, convenience, and distinctive urban charm."
        }
        price={"1.79M"}
      />
      <Title

      ...
      <Carousel
        ...
        <CarouselContent className="my-5 md:m-11  lg:text-2xl font-light  ">
          {reviews.map((review) => (
            <CarouselItem
              key={review.id}
              className="relative flex flex-col items-start justify-center text-royal  text-justify shadow-md rounded-md py-6 mx-2 lg:mx-5 px-5  lg:px-32 ">
              <span className="absolute z-40 -top-5 right-5 lg:-top-11 lg:left-11">
                {quotes}
              </span>
              <p className="mb-3">⭐⭐⭐⭐⭐</p>
              <p>{review.text}</p>

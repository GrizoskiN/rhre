          ...
          ({ id, text1, img, address, address2, logo, Projectlink }) => (
            <li
              ...
              <div className="  w-80  lg:w-[556px]    relative  ">
                <Link href={Projectlink} className=" bg-gray-200  rounded-xl p-5 absolute bottom-4 left-[5%] right-[5%] lg:opacity-0 lg:group-hover:opacity-100 z-20 lg:-bottom-32 lg:group-hover:bottom-5 transition-all duration-500">
                  ...
                  <div href={Projectlink} className="flex justify-between items-end mt-4 ">

...
export default function IndexCarousel({ menuRef, width, services }) {
  return (
    <div
      ref={menuRef}
          ...
          ({ id, text1, img, address, address2, logo, Projectlink }) => (
            <li
              ...
              <div className="  w-80  lg:w-[556px]    relative  ">
                <Link
                  href={Projectlink}
                  className=" bg-gray-200  rounded-xl p-5 absolute bottom-4 left-[5%] right-[5%] lg:opacity-0 lg:group-hover:opacity-100 z-20 lg:-bottom-32 lg:group-hover:bottom-5 transition-all duration-500">
                  <div className="lg:flex justify-between items-center text-center ">
                    ...
                    <Image
                      ...
                      height={30}
                      quality={90}
                      alt={`${text1} developer logo`}
                      className="absolute right-4 bottom-3 lg:right-0 lg:bottom-0 w-24 object-cover  lg:relative lg:w-[130px] pt-1 mix-blend-exclusion "
                    />
                  </div>
                  <div
                    href={Projectlink}
                    ...
                    <div className="hidden lg:flex lg:flex-col w-1/2">
                      <h4 className=" text-royal  text-xl">{address2}</h4>
                      <h3 className="font-bold text-royal text-4xl">
                        {address}
                      </h3>
                    </div>

...
const ProjectInfo = ({ price, handover, payment,qr, ph, bedrooms }) => {
  return (
  <div className="w-11/12 m-auto  text-royal  lg:my-32 pt-24 py-32">
        ...
        <h5 className="text-center text-2xl lg:text-3xl -mt-11 mb-16">{bedrooms}</h5>  
      ...
      <div className=" py-3 lg:mt-5 ">
        ...
        <h2 className="font-bold text-4xl lg:text-5xl xl:text-6xl border-y-[1px] lg:border-y-2 border-royal pb-4 pt-2 mt-4">{payment} <span className="text-lg">{ph}</span></h2>
        <h3></h3>
      </div>
    </div>

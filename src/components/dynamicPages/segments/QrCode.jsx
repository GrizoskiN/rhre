...
const QrCode = ({permit, parts}) => {
  return (
    <div className="">
      <h3 className=""><span className="font-bold">Permit Number: <a target="_blank" href={parts[4]}><Image src="/img/qrcode.png" width={150} height={150} className=""/></a></span> {permit}</h3>
      {/* {parts[4] && (
